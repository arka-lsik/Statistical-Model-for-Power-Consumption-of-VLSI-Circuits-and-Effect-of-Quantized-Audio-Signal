...
## 📝 **Details of Algorithm Pipeline for Power Estimation of VLSI Circuits and Which stages**
...
- This data set was taken fr0m $\textcolor{red}{ISCAS'89}$ conference, which contains 20 different bench mark sequential circuits.
...
- $\textcolor{red}{Regularization \apce Value:}$ This parameter adds a small positive constant to the diagonal of the covariance matrices during the M-step. Its purpose is to:
